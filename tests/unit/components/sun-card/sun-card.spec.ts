...
import { SunCard } from "../../../../src/components/sun-card/sun-card";
...
jest.mock("../../../../src/components/error-content", () => require("../../../mocks/error-content"));
jest.mock("../../../../src/components/sun-card/card-content", () => require("../../../mocks/card-content"));
...
describe("SunCard", () => {
  ...
  describe("getConfigElement", () => {
    it("creates and return a sun card config element", () => {
      ...
      expect(createElementSpy).toHaveBeenCalledWith(Editor.cardType);
    });
  });
